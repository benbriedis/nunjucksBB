...
const node = __importStar(require("./node-loaders"));
const web = __importStar(require("./web-loaders"));
__exportStar(require("./node-loaders"), exports);
__exportStar(require("./web-loaders"), exports);
exports.default = {
