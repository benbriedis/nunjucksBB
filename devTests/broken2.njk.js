...
output += "\n\n";
output += runtime.suppressValue((lineno = 9, colno = 19, await runtime.callWrap(runtime.memberLookup((t_1),"brokenMacro1"), "inc[\"brokenMacro1\"]",context,[])), env.opts.autoescape);
output += "\n";
if(parentTemplate)
